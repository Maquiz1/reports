...
df_L = df_T[(df_T['what_is_the_main_occupatio'] == 1) | (df_T['what_is_the_main_occupatio'] == 2) | (
    df_T['what_is_the_main_occupatio'] == 3)]
...
df1 = df_L[(df_L['what_is_the_main_occupatio'] == 1)]
df2 = df_L[(df_L['what_is_the_main_occupatio'] == 2)]
df3 = df_L[(df_L['what_is_the_main_occupatio'] == 3)]
