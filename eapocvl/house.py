...
df_L = df_T[(df_T['do_you_your_family_or_guar'] == 1) | (df_T['do_you_your_family_or_guar'] == 2)]
...
df1 = df_L[(df_L['do_you_your_family_or_guar'] == 1)]
df2 = df_L[(df_L['do_you_your_family_or_guar'] == 2)]
