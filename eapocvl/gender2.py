...
# df = df['participant_s_gender'].value_counts()
# print(df)
...
df_L = df_T[(df_T['participant_s_gender'] == 1) | (df_T['participant_s_gender'] == 2)]
...
df1 = df_L[(df_L['participant_s_gender'] == 1)]
df2 = df_L[(df_L['participant_s_gender'] == 2)]
