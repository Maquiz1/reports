...
# df = df['has_intensive_adherence_co_mon6'].value_counts()
# print(df)
...
df_L = df_T[(df_T['has_intensive_adherence_co_mon6'] == 1) | (df_T['has_intensive_adherence_co_mon6'] == 2)]
...
df1 = df_L[(df_L['has_intensive_adherence_co_mon6'] == 1)]
df2 = df_L[(df_L['has_intensive_adherence_co_mon6'] == 2)]
