...
df_L = df_T[(df_T['has_the_participant_ever'] == 1) | (df_T['has_the_participant_ever'] == 2) | (
    df_T['has_the_participant_ever'] == 3)]
...
df1 = df_L[(df_L['has_the_participant_ever'] == 1)]
df2 = df_L[(df_L['has_the_participant_ever'] == 2)]
df3 = df_L[(df_L['has_the_participant_ever'] == 3)]
...
# print(f'N/A (Intervtn)                         : {df3_i_T}')
# print(f'N/A (Intervtn)                         : {df3_i_P} %')
...
# print(f'N/A (Control)                          : {df3_c_T}')
# print(f'N/A (Control)                          : {df3_c_P} %')
