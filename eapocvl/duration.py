...
df_L = df_T[(df_T['when_was_the_participant_f'] != '')]
...
df_L = df_L['when_was_the_participant_f']
# df_L = df_L.info()
...
# df_i_T = df_i_T['when_was_the_participant_f']
# df_i_M = df_i_T.median()
# df_i_R = df_i_T.max() - df_i_T.min()

# df_c_T = df_c_T['when_was_the_participant_f']
