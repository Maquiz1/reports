...
df = df['does_the_participant_have_mon6'].value_counts()
print(df)
...
df_L = df_T[(df_T['does_the_participant_have_mon6'] == 1) | (df_T['does_the_participant_have_mon6'] == 2)]
...
df1 = df_L[(df_L['does_the_participant_have_mon6'] == 1)]
df2 = df_L[(df_L['does_the_participant_have_mon6'] == 2)]
