...
# df = df['do_you_have_your_own_child'].value_counts()
# print(df)
...
df_L = df_T[(df_T['do_you_have_your_own_child'] == 1) | (df_T['do_you_have_your_own_child'] == 2)]
...
df1 = df_L[(df_L['do_you_have_your_own_child'] == 1)]
df2 = df_L[(df_L['do_you_have_your_own_child'] == 2)]
