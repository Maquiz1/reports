...
df_L_today = df_L['visit_date']
df_L_date = df_L['date_of_informed_consent']
...
df_L_i_today = df_i_T['visit_date']
df_L_i_date = df_i_T['date_of_informed_consent']

df_L_c_today = df_c_T['visit_date']
df_L_c_date = df_c_T['date_of_informed_consent']
