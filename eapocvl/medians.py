...
# df = df['how_many_children_do_you_h'].value_counts()
# print(df)
...
for col in df.columns:
    print(col)
# df_L = df_T[(df_T['how_many_children_do_you_h'])].median()
...
# df1_i = df_L[(df_L['redcap_data_access_group'] == 'mwananyamala_hospi') | (df_L['redcap_data_access_group'] == 'mnazi_mmoja_hospit')]

# df1_c = df_L[(df_L['redcap_data_access_group'] == 'amana_hospital') | (df_L['redcap_data_access_group'] == 'sinza_hospital')]
