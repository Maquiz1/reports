...
df1_1 = df1[(df1['whom_does_the_participant'] == 1)]
df1 = df1[(df1['whom_does_the_participant'] == 1)]
df1 = df1[(df1['whom_does_the_participant'] == 1)]
df1 = df1[(df1['whom_does_the_participant'] == 1)]

df2 = df2[(df2['whom_does_the_participant'] == 2)]
df3 = df3[(df3['whom_does_the_participant'] == 3)]
df4 = df4[(df4['whom_does_the_participant'] == 4)]
