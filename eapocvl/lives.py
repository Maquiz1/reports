...
# df = df['whom_does_the_participant'].value_counts()
# df = df['redcap_data_access_group'].value_counts()
# print(df)

df = df[(df['redcap_data_access_group'] == 'amana_hospital') | (df['redcap_data_access_group'] == 'mnazi_mmoja_hospit') | (
    df['redcap_data_access_group'] == 'mwananyamala_hospi') | (df['redcap_data_access_group'] == 'sinza_hospital')]


df = df[(df['whom_does_the_participant'] == 1) | (df['whom_does_the_participant'] == 2) | (
    df['whom_does_the_participant'] == 3) | (df['whom_does_the_participant'] == 4) | (df['whom_does_the_participant'] == 5)
    | (df['whom_does_the_participant'] == 6) | (df['whom_does_the_participant'] == 7) | (df['whom_does_the_participant'] == 8)]
